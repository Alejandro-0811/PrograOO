...
function autoSlide() {
   ...
   }, 3000); // velocidad del carrusel = 3s
}
...
function slide(toIndex) {
   ...
   // Corrección de índices negativos o superiores al límite
   ...
   if (toIndex > itemActiveIndex) {
      ...
      // Inicia la transición hacia la derecha
      ...
      // Inicia la transición hacia la izquierda
   ...
   // Elimina todas las clases de transición antiguas y cambia la clase activa
